...
public class ZhongLeiItemAdapter extends SimpleRecyclerAdapter<ZhongLeiItems.DataBean.ItemsBean> {


    public ZhongLeiItemAdapter(List<ZhongLeiItems.DataBean.ItemsBean> list, Context ctx) {
        super(list, ctx);
    }
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, int position) {
        ...
        ZhongLeiItems.DataBean.ItemsBean itemsBean = list.get(position);
